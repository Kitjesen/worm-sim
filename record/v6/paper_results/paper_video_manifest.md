...
| --- | --- | ---: | --- | --- | --- |
| flat | random | 0.500 | ok | record/v6/videos/eval_flat_random.mp4 | record/v6/paper_results/video_eval_flat_random.json |
| sand | random | 1.000 | ok | record/v6/videos/eval_sand_random.mp4 | record/v6/paper_results/video_eval_sand_random.json |
| slope | random | 0.000 | ok | record/v6/videos/eval_slope_random.mp4 | record/v6/paper_results/video_eval_slope_random.json |
