...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| flat | `needs_raw_csv` | pending_real_run | 0.500 | 0.000 | 0.000 |  | no |
| sand | `needs_raw_csv` | pending_real_run | 1.000 | 0.000 | 0.000 |  | no |
| slope | `needs_raw_csv` | pending_real_run | 0.000 | 0.000 | 0.000 |  | no |
