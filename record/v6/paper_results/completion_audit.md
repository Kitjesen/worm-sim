...
| hardware deploy preflight report | missing | hardware deploy preflight ABI fingerprint, hardware deploy preflight actuator contract |
| sim sensor to hardware-policy bridge | ok |  |
| 12 PPO training model artifacts | missing | runs/worm_v6_ppo_flat_random, runs/worm_v6_ppo_sand_worm, runs/worm_v6_ppo_sand_snake, runs/worm_v6_ppo_sand_mixed, runs/worm_v6_ppo_sand_random, runs/worm_v6_ppo_slope_worm, runs/worm_v6_ppo_slope_snake, runs/worm_v6_ppo_slope_mixed, runs/worm_v6_ppo_slope_random |
...
| 3 continuous gait_blend scan result files | missing | runs/worm_v6_blend_scan_flat_random/scan_results.json, runs/worm_v6_blend_scan_sand_random/scan_results.json, runs/worm_v6_blend_scan_slope_random/scan_results.json |
