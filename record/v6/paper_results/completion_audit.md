...
| --- | --- | --- |
| hardware template/schema | missing | hardware schema observation_contract_fingerprint |
| online deploy runtime tools | ok |  |
| hardware deploy preflight report | missing | hardware deploy preflight complete, hardware deploy preflight ABI fingerprint, hardware deploy preflight terrain status |
