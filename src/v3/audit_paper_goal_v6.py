...
def check_deploy_runtime_tools():
    paths = [
        "src/v3/build_hardware_obs_v6.py",
        "src/v3/audit_observation_sources_v6.py",
        "src/v3/check_controller_stream_v6.py",
        "src/v3/deploy_policy_v6.py",
        "src/v3/motor_contract_v6.py",
        "src/v3/hardware_policy_runtime_v6.py",
        "src/v3/preflight_hardware_deploy_v6.py",
        "src/v3/process_hardware_trial_v6.py",
        "src/v3/summarize_hardware_validation_v6.py",
        "src/v3/test_observation_source_audit_v6.py",
        "src/v3/test_controller_stream_check_v6.py",
        "src/v3/test_hardware_validation_summary_v6.py",
        "src/v3/test_hardware_preflight_v6.py",
        "src/v3/test_hardware_policy_runtime_v6.py",
        "src/v3/test_motor_contract_v6.py",
    ]
    missing = [p for p in paths if not exists(os.path.join(PROJECT_ROOT, p))]
