...
def recommended_commands(audit, missing):
    ...
    if "9 CMA-ES open-loop baseline JSON files" in missing:
        ...
        if target:
            ...
            commands.append((
                ...
                "python src/v6/run_terrain_experiments.py --method cmaes "
    ...
    post_train_missing = {
        ...
        "3 fixed-gate gait_blend ablation scan result files",
    ...
    if "flat/sand/slope hardware logs with video references" in missing:
        ...
        commands.append((
            ...
            "python src/v6/capture_hardware_stream_v6.py --input-jsonl "
        ...
        commands.append((
            ...
            "python src/v6/process_hardware_trial_v6.py --terrain flat "
        ...
        commands.append((
            ...
            "python src/v6/process_hardware_trial_v6.py --terrain sand "
            "--mode random --input-jsonl controller_stream.jsonl "
        ...
        commands.append((
            ...
            "python src/v6/process_hardware_trial_v6.py --terrain slope "
            "--mode random --input-jsonl controller_stream.jsonl "
        ...
        commands.append((
            ...
            "python src/v6/import_hardware_trial_v6.py --terrain flat "
            "--mode random --raw-csv "
            "record/v6/hardware/field_trials/current/flat/"
        ...
        commands.append((
            ...
            "python src/v6/import_hardware_trial_v6.py --terrain sand "
            "--mode random --raw-csv "
            "record/v6/hardware/field_trials/current/sand/"
        ...
        commands.append((
            ...
            "python src/v6/import_hardware_trial_v6.py --terrain slope "
            "--mode random --raw-csv "
            "record/v6/hardware/field_trials/current/slope/"
        ...
        commands.append((
            ...
            "python src/v6/validate_hardware_log_v6.py --input <log.csv> "
