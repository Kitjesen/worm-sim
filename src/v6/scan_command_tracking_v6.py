...
def main():
    ...
    ap.add_argument("--vx-values", default="-0.25,-0.125,0,0.125,0.25")
    ap.add_argument("--vy-values", default="-0.15,-0.075,0,0.075,0.15")
    ap.add_argument("--yaw-values", default="-0.5,-0.25,0,0.25,0.5")
